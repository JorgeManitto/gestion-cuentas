                    ...
                    @else
                      ...
                      @if ($showCredentials || $activationKey)
                        ...
                        @if ($showCredentials)
                          ...
                          <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                 style="margin:12px 0 4px 0;background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;">
                            <tr>
                              <td style="padding:12px 14px;color:#7c2d12;font-size:13px;line-height:1.5;">
